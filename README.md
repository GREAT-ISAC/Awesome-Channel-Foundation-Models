...
|---|---|
| [CFM papers](papers/README.md) | Research taxonomy with available implementation and evaluation links |
...
Use the [resource proposal Issue Form](https://github.com/GREAT-ISAC/Awesome-Channel-Foundation-Models/issues/new?template=resource-proposal.yml) to suggest a paper or resource. Direct pull requests can follow the short [contribution guide](CONTRIBUTING.md).
